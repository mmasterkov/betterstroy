...
<nav id="stuck_container" class="navbar navbar-default navbar-static-top tm_navbar clearfix" role="navigation">
        <div class="container">
            ...
            <ul class="nav sf-menu clearfix">
				...
				<li class="active"><a href="/prices">Цены</a></li>
...
<div class="content"> 
        ...
        <a  name="services"><div class="container"></a>
             <h3 class="wow fadeIn">Цены на наши услуги</h3>
            <div class="container">
...
<div>
	<div class="price_title">Цены на <a href="/fas">фасадные работы</a></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="indent maxheight">
						...
						<p> г.Москва <br> ул.Истринская, д. 6</p>
                    </div>
                </div>
            </div>
        </div>
