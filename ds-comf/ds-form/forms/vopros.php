...
define('SUBJECT', 'Задать вопрос на сайте '.str_replace('www.', '', $_SERVER['HTTP_HOST']));										//Тема письма
...
array(
	...
	'attributs' => array(
					'type'=>'submit',
					'value'=>'Отправить',
					'onclick'=>'yaCounter29696835.reachGoal(\'formvopros\');  ga(\'send\', \'pageview\', \'/formvopros/\');',
				   ),
	),
/*--Текст для звездочки--*/
array(
